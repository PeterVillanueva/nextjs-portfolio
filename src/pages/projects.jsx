...
const FeaturedProject = ({type, title, summary, img, link, github}) => {
    ...
    return (
        <article className="w-full flex items-center justify-between rounded-3xl border-solid border border-dark bg-light shadow-2xl p-12 relative rounded-br-2xl dark:bg-dark dark:border-light
...
const Project = ({title, type, img, link, github}) => {
    ...
    return (
        <article className="w-full flex flex-col items-center justify-center rounded-2xl border-solid border border-dark bg-light shadow-2xl p-6 relative dark:bg-dark dark:border-light xs:p-4">
...
const projects = () => {
    return (
        <>
            <Head>
                <title>Peter Villanueva | Projects</title>
